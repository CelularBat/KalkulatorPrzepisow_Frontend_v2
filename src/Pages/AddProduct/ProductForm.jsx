...
function ProductForm({IsProductFormInEditMode,EditRowData,onProductFormSubmit,onProductFormClose}) {
  ...
  return(
    <ProductFormRender {...{FormData,handleChange,cleanForm,IsProductFormInEditMode,onProductFormSubmit,onProductFormClose}} />
  );
}
   

const ProductFormRender = ({FormData,handleChange,cleanForm,IsProductFormInEditMode,onProductFormSubmit,onProductFormClose})=>{
  return (
